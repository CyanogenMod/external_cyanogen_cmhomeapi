 ...
 *
 * <p>CardData includes many possible fields, and not all of them are required. Use the various subclasses to
 * create specific types of CardData.
 * @see org.cyanogenmod.launcher.home.api.cards.LoginCardData
 * @see org.cyanogenmod.launcher.home.api.cards.MessageCardData
 * @see org.cyanogenmod.launcher.home.api.cards.NewsCardData
 * @see org.cyanogenmod.launcher.home.api.cards.PhotoCardData
 * @see org.cyanogenmod.launcher.home.api.cards.PlaceCardData
 *
...
public class CardData extends PublishableCard {
    ...
    /**
     * This key is used when a CardData object matches {@link org.cyanogenmod.launcher.home.api.cards.CardData}
     * and is returned from {@link #determineType(CardData)}
     */
    public static final int CARD_DATA_TYPE_KEY = 0;
    /**
     * This key is used when a CardData object matches {@link org.cyanogenmod.launcher.home.api.cards.LoginCardData}
     * and is returned from {@link #determineType(CardData)}
     */
    public static final int LOGIN_CARD_TYPE_KEY = 1;
    /**
     * This key is used when a CardData object matches {@link org.cyanogenmod.launcher.home.api.cards.MessageCardData}
     * and is returned from {@link #determineType(CardData)}
     */
    public static final int MESSAGE_CARD_TYPE_KEY = 2;
    /**
     * This key is used when a CardData object matches {@link org.cyanogenmod.launcher.home.api.cards.NewsCardData}
     * and is returned from {@link #determineType(CardData)}
     */
    public static final int NEWS_CARD_TYPE_KEY = 3;
    /**
     * This key is used when a CardData object matches {@link org.cyanogenmod.launcher.home.api.cards.PhotoCardData}
     * and is returned from {@link #determineType(CardData)}
     */
    public static final int PHOTO_CARD_TYPE_KEY = 4;
    /**
     * This key is used when a CardData object matches {@link org.cyanogenmod.launcher.home.api.cards.PlaceCardData}
     * and is returned from {@link #determineType(CardData)}
     */
    ...
    /**
     * Create a new CardData from an existing CardData, copying all of it's fields.
     * @param cardData An input CardData object.
     */
    ...
    */
    ...
    /**
     * Publish this card immediately to CM Home.
     * @param context The context to be used for Resource retrieval.
     * @throws MissingFieldPublishException If the required fields for this type of CardData are not present.
     */
    @Override
