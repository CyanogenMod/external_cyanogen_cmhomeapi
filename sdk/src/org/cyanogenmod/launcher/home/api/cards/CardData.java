...
public class CardData extends PublishableCard {
    ...
    */
     ...
     *
     * <p><b>This is intended to be an internal SDK method. Use {@link org.cyanogenmod.launcher.home
     * .api.cards.CardData#getAllPublishedCards(Context)} to retrieve cards.</b></p>
     *
     * @see org.cyanogenmod.launcher.home.api.cards.CardData#getAllPublishedCardDatas(android.content.Context)
    ...
    public static final class CardDeletedInfo implements Parcelable {
         ...
         * @param globalId A String that represents this card globally,
         *                 among all CM Home extensions installed on the device.
         */
