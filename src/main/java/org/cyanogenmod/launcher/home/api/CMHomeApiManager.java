...
public class CMHomeApiManager {
        ...
        ContentResolver contentResolver = mContext.getContentResolver();
         for (Map.Entry<String, ProviderInfo> entry : mProviders.entrySet()) {
             ...
             Uri getCardsUri = Uri.parse("content://" + providerInfo.authority + "/" +
                                         CmHomeContract.CardData.LIST_INSERT_UPDATE_URI_PATH);
             Uri getImagesUri = Uri.parse("content://" + providerInfo.authority + "/" +
                                          CmHomeContract.CardDataImage.LIST_INSERT_UPDATE_URI_PATH);
    ...
    private void onCardInsertOrUpdate(Uri uri) {
        ...
        Cursor cursor = contentResolver.query(uri,
                                              CmHomeContract.CardData.PROJECTION_ALL,
                                              null,
                                              null,
                                              CmHomeContract.CardData.DATE_CREATED_COL);
    ...
    private UriMatcher getUriMatcherForAuthority(String authority) {
        ...
        matcher.addURI(authority,
                       ...
                       CARD_DATA_LIST);
        matcher.addURI(authority,
                       CmHomeContract.CardData.SINGLE_ROW_INSERT_UPDATE_URI_PATH,
                       CARD_DATA_ITEM);
        matcher.addURI(authority,
                       CmHomeContract.CardData.SINGLE_ROW_DELETE_URI_PATH_MATCH,
                       CARD_DATA_DELETE_ITEM);
        matcher.addURI(authority,
                       CmHomeContract.CardDataImage.LIST_INSERT_UPDATE_URI_PATH,
                       CARD_DATA_IMAGE_LIST);
        matcher.addURI(authority,
                       CmHomeContract.CardDataImage.SINGLE_ROW_INSERT_UPDATE_URI_PATH,
                       CARD_DATA_IMAGE_ITEM);
        matcher.addURI(authority,
                       CmHomeContract.CardDataImage.SINGLE_ROW_DELETE_URI_PATH_MATCH,
