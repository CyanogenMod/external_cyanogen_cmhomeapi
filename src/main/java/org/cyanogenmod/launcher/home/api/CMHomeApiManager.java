...
public class CMHomeApiManager {
    ...
    private void cardImageInsertOrUpdate(CardDataImage newImage) {
    ...
    private void removeCardDataImage(String cardDataImageGlobalId) {
    ...
    public void processPendingUpdates() {
        ...
        for(CardDataImage cardDataImage : mPendingImageUpdates) {
            cardImageInsertOrUpdate(cardDataImage);
        }

        for (String imageId : mPendingImageRemovalIds) {
            removeCardDataImage(imageId);
        }
    }
